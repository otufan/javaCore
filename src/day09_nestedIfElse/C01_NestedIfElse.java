...
public class C01_NestedIfElse {
	...
	public static void main(String[] args) {
	 ...
	 //Eger ilk harf kucuk harf ise “z” olup olmadigini kontrol edin. Ilk harf z ise  “Gecerli Sifre”  degilse “Gecersiz Sifre” yazdirin.
		...
		} else if (ilkKarakter>='a' && ilkKarakter<='z') { if (ilkKarakter=='z') { System.out.println("Gecerli Sifre!!!");
		...
		else { System.out.println("Gecerli sifre olmasi icin harfle baslayiniz!!!");
