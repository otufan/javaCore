...
public class C01_LinkedList {
	...
	public static void main(String[] args) {
		...
		//linked list in 2 tane inteface parent i vardir. Bunlardan bir tanesi List digeri de Deque ==> Queue
		
		
		ll.add(0, 10); //List interface den gelen ozellikle basa eleman ekleme
		System.out.println(ll);//[10, 5, 7]
		ll.addFirst(3);//queue interface den gelen ozellikle ile basa eleman ekleme
