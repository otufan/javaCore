...
public class C01_CarRunner {
	...
	public static void main(String[] args) {
		...
		//ancak baska package da oldugu icin icinde oldugumuz class dan Car class indaki variable lara ulasabilmemiz icin
		...
		System.out.println(car1.km + " " + car1.model + " " + car1.renk + " " + car1.yil+ " " + car1.satilikMi);//80000 VolksWagen Gri 2000 false

		
		Car1 car2=new Car1();
		
		System.out.println(car2.km + " " + car2.model + " " + car2.renk + " " + car2.yil+ " " + car2.satilikMi);//0 null null 2000 false
		//yeni obje olusturdugumuz icin default (ilk class icinde olusturdugumuz) degerler gelir
		...
		System.out.println(car3.km + " " + car3.model + " " + car3.renk + " " + car3.yil+ " " + car3.satilikMi);//40000 null null 2000 true
	}
