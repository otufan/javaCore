...
*/
		...
		do {System.out.print("Lutfen bir sifre giriniz : ");
	...
	public static boolean buyukHarfKontrol(String sifre) {
		...
		for (int i = 0; i < sifre.length(); i++) {
			...
			if(harfler.contains(sifre.substring(i, i+1))){bhk=true;
			break;
		...
		if(!bhk) { System.out.println("Sifreniz en az bir buyuk harf icermelidir!!!");
	...
	public static boolean kucukHarfKontrol(String sifre) {
		...
		for (int i = 0; i < sifre.length(); i++) {
			...
			if(harfler.contains(sifre.substring(i, i+1))){khk=true;
			break;
		...
		if(!khk) { System.out.println("Sifreniz en az bir kucuk harf icermelidir!!!");
